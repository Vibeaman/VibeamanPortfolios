...
import animeAvatar from '@/assets/portrait.jpeg';
...
export default function About() {
  ...
  const personSchema = {
    ...
    alternateName: photographerInfo.tagline,
    description: aboutDescription,
    image: aboutImage,
    jobTitle: 'Fullstack Engineer & Smart Contract Developer',
    url: window.location.origin,
    sameAs: [
      photographerInfo.socialLinks.x,
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-start">
            ...
            >
              <div className="aspect-[3/4] relative overflow-hidden rounded-sm bg-muted">
                ...
                />
                {/* Anime alter ego */}
                <div className="absolute bottom-4 right-4 size-20 md:size-24 overflow-hidden rounded-full border border-white/30 shadow-lg backdrop-blur-sm">
                  <img
                    src={animeAvatar}
                    alt={`${photographerInfo.tagline} anime alter ego`}
              ...
              <p className="text-xs font-light tracking-widest uppercase text-muted-foreground">
                {photographerInfo.tagline} · alter ego
              </p>
