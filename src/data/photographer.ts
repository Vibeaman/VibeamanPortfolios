...
Whether it is a landing page, a complex dashboard, an API, or a smart contract, I obsess over the details that compound: type safety, clean state, gas efficiency, and interfaces people actually enjoy using.`,
  clientQuote: `Every client is special. Every idea is a treasure. I don't just ship code; I partner with founders to turn bold ideas into products people love.`,
  awards: [
    'Frontend: React, Next.js, TypeScript, Tailwind CSS',
    'Backend: Python, Java, Node.js, Go, Rust',
    'Databases & Infra: PostgreSQL, Redis, Docker, AWS, Vercel',
    'Web3: Solidity, Rust, Foundry, Hardhat, Anchor, ethers, viem, wagmi'
  ],
  clients: [
    'Web3 Startups',
    'SaaS Founders',
  ...
  education: 'Professional Photography Certification',
  location: 'Available Worldwide',
  email: 'mbayo012@gmail.com',
  phone: '08102633523',
  availability: 'Actively attending to clients in 2026',
  socialLinks: {
    whatsapp: 'https://wa.me/09121852168',
    telegram: 'https://t.me/Vibeaman',
    x: 'https://x.com/0xvibeaman',
    instagram: 'https://www.instagram.com/vibeamann?igsh=MW1mMDBsNXVuN2hxdw%3D%3D&utm_source=qr',
    linkedin: 'https://www.linkedin.com/in/mayor-bayo-033979330?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app'
  },
  portraitImage: headshot
};
